...
from prompt_helpers import generate_greeting, continue_conversation
...
def group():
    if request.method == "GET":
        ...
        for i in range(len(phone_numbers)):
            ...
            call_sid = make_call(phone_numbers[i][1], generate_greeting(phone_numbers[i][0]))
...
def gather():
    ...
    speech = continue_conversation(user_input)
    call = update_call(call_sid, speech)
